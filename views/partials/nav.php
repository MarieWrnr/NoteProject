                    ...
                    <div class="relative ml-3">
                        <div>
                            <?php if ($_SESSION['user'] ?? false) : ?>
                                ...
                                <div class="absolute right-0 z-10 mt-2 w-24 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                     role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button"
                                     tabindex="-1">
<!--                                    <a href="/logout"-->
<!--                                       class="--><?php //= urlIs('/logout') ? "bg-gray-100" : "" ?><!-- block px-4 py-2 text-sm text-gray hover:bg-gray-100"-->
<!--                                       role="menuitem" tabindex="-1"-->
<!--                                       id="user-menu-item-2">Log out</a>-->
                                    <form action="/session" method="POST">
                                        <input type="hidden" name="_method" value="DELETE">

                                        <button class="<?= urlIs('/logout') ? "bg-gray-100" : "" ?><!-- block px-4 py-2 text-sm text-gray hover:bg-gray-100">Log Out</button>
                                    </form>
                                </div>
